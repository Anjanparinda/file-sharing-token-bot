...
APP_ID = int(os.environ.get("APP_ID", "27560342"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "cd10f0b290f53f7c9a3f22c6cd788b60")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002048085284"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6988460039"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "ravi12345")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "bots_duniya"))
